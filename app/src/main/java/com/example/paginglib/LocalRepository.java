...
public class LocalRepository {
    ...
    public static CouponsDB couponsDB;
    private static final Object LOCK = new Object();
    private static Context ctx;

    public synchronized static CouponsDB getCouponsDB(Context context){
        if(couponsDB == null){
            ctx = context;
            synchronized (LOCK){
                if(couponsDB == null){
                    couponsDB = Room.databaseBuilder(context, CouponsDB.class, "Coupons Database")
    ...
    private static void addCoupons(Context ctx){
        ...
        getCouponsDB(ctx).couponLocalDAO().insertCoupons(couponList);
    }
